...
# ✅ Load dataset
file_path = os.path.expanduser("~/Downloads/Car Price Predictor Data Doc.csv")

if not os.path.exists(file_path):
    st.error("❌ File not found! Ensure 'Car Price Predictor Data Doc.csv' is in your Downloads folder.")
    st.stop()
